...
<div class="col-md-12 col-sm-12">
        <div class="card-box mb-5 py-3">
            <h4 class="text-center">LISTE DES STUDIOS MODERNES</h4>
        </div>
    </div>
    ...
    <div class="col-md-12 col-sm-12  p-2">
        <div class="row">
            ...
            $sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE STATUS ='Present' AND type_logement = 'Studio Moderne' LIMIT $offset, $itemsPerPage";
