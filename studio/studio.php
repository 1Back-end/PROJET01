...
<?php
    ...
    // Aucun studio moderne n'est disponible
    echo '<div class="main-container mt-2 pb-5"><div class="col-md-12 col-sm-12 text-center"><div class="alert alert-warning" role="alert">Aucun studio moderne n\'est disponible pour le moment.</div></div></div>';
}
?>
