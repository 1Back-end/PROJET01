...
if(isset($_GET['id'])) {
    ...
    // Requête SQL pour sélectionner l'utilisateur avec l'ID spécifié, le statut "Present" et le rôle égal à 2
    $sql = "SELECT * FROM utilisateurs WHERE ID = :id AND STATUT = 'Present' AND ROLE = 2";
    try {
...
<div class="main-container mt-2 pb-5">
    <div class="col-md-12 col-sm-12">
        <div class="card-box mb-30 py-3">
            <h4 class="text-center">DETAILS DE L'AGENT IMMOBILIER N° <?php echo $utilisateur['TOKEN']; ?></h4>
        </div>
    </div>
    <div class="col-md-12 col-sm-12">
    <div class="row">
