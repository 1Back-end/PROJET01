...
<div class="container mt-5 pb-5 ">
   ...
   <form action="" method="post"  enctype="multipart/form-data">
    <div class="row">
        ...
        <h6 id="choose-image font-12">Cliquez pour choisir une photo</h6>
        <!-- Input file caché pour le téléchargement de la nouvelle photo -->
        <input type="file" required name="photo" id="upload-image" style="display: none;" accept="image/*">
        ...
        <div class="col-md-8 p-1 col-sm-12">
...
<div class="mb-3">
    <input type="text" class="form-control py-3" name="prenom" placeholder="Veuillez entrer votre prénom">
...
<div class="mb-3">
    <input type="email" class="form-control py-3" placeholder="Veuillez entrer votre adresse email" name="email">
...
<div class="mb-3">
    <select class="form-control font-12" name="type_compte" style="cursor:pointer;">
        <option></option>
...
<div class="mb-3 d-grid gap-2 d-md-block">
    <a href="../index.php" class="btn btn-add  btn-responsive mb-2 btn-danger">Annuler <i class="fas fa-times-circle"></i></a>
    <button id="submitBtn" class="btn btn-add btn-responsive mb-2  btn-primary" type="submit" name="enregistrer">Continuer <i class="fas fa-arrow-right"></i></button>
