...
<div class="main-container mt-2 pb-5">
    ...
    <div class="col-md-12 col-sm-12 p-2">
        <div class="row">
            ...
            $sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE STATUS ='Present' AND type_logement = 'Appartement Moderne' LIMIT $offset, $itemsPerPage";
                    ...
                    <div class="col-md-4 col-sm-12 p-3 col-xxl-12">
                        <div class="card-box mb-10 text-white text-center p-2">
                            ...
                            <div class="btn-group  text-center" role="group" aria-label="Options">
                                <a href="details.php?id=<?php echo $row['id']; ?>" class="btn  btn-add btn-sm  btn-success text-white mx-2">Voir plus</a>
                            </div>
                        </div>
                    </div>
            <?php
    ...
    <div class="col-md-12 col-sm-12 text-center">
        <ul class="pagination justify-content-center">
            ...
            $totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE STATUS ='Present' AND type_logement = 'Appartement'";
