...
// Requête SQL pour récupérer les appartements avec une seule image aléatoire et triées par date d'ajout ASC
$itemsPerPage = 6;
$offset = ($currentPage - 1) * $itemsPerPage;
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE STATUS ='Present' AND type_logement = 'Appartement Moderne' ORDER BY date_ajout ASC LIMIT $offset, $itemsPerPage";
$result = $connexion->query($sql);

// Vérification si la requête a réussi et s'il y a des appartements modernes disponibles
    ...
    <div class="main-container mt-2 pb-5">
        <div class="col-md-12 col-sm-12">
            <div class="card-box mb-5 py-3">
                <h4 class="text-center">LISTE DES APPARTEMENTS MODERNES</h4>
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12 text-center">
            <ul class="pagination justify-content-center">
                ...
                $totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE STATUS ='Present' AND type_logement = 'Appartement Moderne'";
...
<?php
    ...
    // Aucun appartement moderne n'est disponible
    echo '<div class="main-container mt-2 pb-5"><div class="col-md-12 col-sm-12 text-center"><div class="alert alert-warning" role="alert">Aucun appartement moderne n\'est disponible pour le moment.</div></div></div>';
}
?>
