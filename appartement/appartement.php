...
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits  WHERE statut ='Accepté' AND STATUS ='Present' AND type_logement = 'Appartement Moderne' ORDER BY date_ajout ASC LIMIT $offset, $itemsPerPage";
...
<?php
    ...
    echo '<div class="main-container mt-2 pb-5"><div class="col-md-12 col-sm-12 text-center"><div class="alert alert-info" role="alert">Aucun appartement moderne n\'est disponible pour le moment.</div></div></div>';
}
?>
