...
<div class="col-md-12 col-sm-12 ">
  ...
  <div class="card-box p-3 mb-3 d-flex justify-content-between align-items-center">
   <div class="mr-auto">
   <h5 class="text-uppercase">LISTE REGIONS</h5>
   </div>
     <div class="ml-auto">
     <a href="../ajouter/add_region.php" class="btn btn-dark btn-add btn-sm mt-2 mt-sm-0 order-sm-2"><i class="bi bi-plus-circle mr-2"></i>AJOUTER</a>
     </div>
  </div>
</div>
    ...
    if (empty($result)) {
        echo "<div class='col-md-12 col-sm-12'><div class='alert alert-success text-center' role='alert'>Vous n'avez aucune région enregistrée.</div></div>";
    } else {
    ?>
    <div class="col-md-12 col-sm-12">
