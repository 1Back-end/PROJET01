...
<head>
    <meta charset="utf-8">
    <title>RAYALE VENTE DE TERRAINS</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <link rel="shortcut icon" href="../package/img/rayale.png" type="image/x-icon">
        ...
        <div class="container-fluid header bg-white p-0">
            <div class="row g-0 align-items-center flex-column-reverse flex-md-row">
                <div class="col-md-6 p-5 mt-lg-5"><br><br><br>
                    <h1 class="display-5 animated fadeIn mb-4">Trouvez votre <span class="text-primary"> Terrain </span> chez IMMO INVESTMENT SCI</h1> 
                    <p>
        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-md-6 col-sm-12">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    <h1 class="mb-3 font-24">Liste de terrains en vente</h1>
                    <p>Plongez dans notre collection de terrain, 
...
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE  statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Terrain' AND statut_Louer = 'A Vendre'";
...
$totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Terrain' AND statut_Louer = 'A Vendre'";
...
?>
    <div class="row">
        ...
        <?php
            ...
            echo '<div class="alert alert-info" role="alert">Aucun terrain en vente n\'a encore été enregistré.</div>';
