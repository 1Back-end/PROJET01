            ...
            <div class="navbar-nav ms-auto">
                ...
                <div class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu rounded-0 m-0 ">
                        ...
                        <a href="../pages/immeuble.php" class="dropdown-item">immeuble</a>
        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    <h1 class="mb-3">Liste d'immeubles à louer</h1>
                    <p>Découvrez notre sélection de studios modernes, 
                        offrant des espaces à la fois chic et pratiques 
                        pour répondre à vos besoins de confort et à votre 
                        mode de vie Satisfaisant.</p>
                </div>
            </div>
        </div>
...
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Immeuble' AND statut_Louer = 'A Louer'";
...
$totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Immeuble' AND statut_Louer = 'A Louer'";
...
?>
    <div class="row">
        ...
        <?php
            ...
            echo '<div class="alert alert-info" role="alert">Aucun  Immeuble à louer n\'a encore été enregistré.</div>';
