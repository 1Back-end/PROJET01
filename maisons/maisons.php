...
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits  WHERE statut ='Accepté' AND STATUS ='Present' AND type_logement = 'Maison' ORDER BY date_ajout ASC LIMIT $offset, $itemsPerPage";
    ...
    <div class="main-container mt-2 pb-5">
        <div class="col-md-12 col-sm-12">
            <div class="card-box mb-5 py-3">
                <h4 class="text-center">LISTE DE MAISONS</h4>
            </div>
        </div>
        ...
        <div class="col-md-12 col-sm-12 text-center">
            <ul class="pagination justify-content-center">
                ...
                $totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE statut ='Accepté' AND STATUS ='Present' AND type_logement = 'Maison'";
...
<?php
    ...
    echo '<div class="main-container mt-2 pb-5"><div class="col-md-12 col-sm-12 text-center"><div class="alert alert-info" role="alert">Aucune maison n\'est disponible pour le moment.</div></div></div>';
}
?>
