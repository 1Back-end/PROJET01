...
$sql = "SELECT * FROM utilisateurs WHERE ROLE = 1 AND STATUT = 'Present' LIMIT :limit OFFSET :offset";
...
$stmt_count = $connexion->prepare("SELECT COUNT(*) FROM utilisateurs WHERE ROLE = 1 AND STATUT = 'Present'");
$stmt_count->execute();
...
<div class="main-container pb-5">
    ...
    <div class="col-md-12 col-sm-12">
        <div class="card-box mb-30 py-2">
            <h4 class="text-center text-uppercase">LISTE DES PROPRIETAIRES</h4>
        </div>
    </div>
