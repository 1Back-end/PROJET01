...
if (isset($_GET['id'])) {
    ...
    if ($role_utilisateur == 1) { // Vérifie si le rôle est "propriétaire"
        ...
        echo "<script>
                ...
                setTimeout(function() {
                    window.location.href = 'proprietaire.php';
...
$stmt = $connexion->prepare("SELECT * FROM utilisateurs WHERE ROLE = 1 AND STATUT = 'Present'");
$stmt->execute();
