        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-md-6 col-sm-12">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    <h1 class="mb-3 font-24">Liste de terrains à louer</h1>
...
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE  statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Terrain' AND statut_Louer = 'A Louer'";
...
$totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Terrain' AND statut_Louer = 'A Louer'";
...
?>
    <div class="row">
        ...
        <?php
            ...
            echo '<div class="alert alert-info" role="alert">Aucun  terrain à louer n\'a encore été enregistré.</div>';
