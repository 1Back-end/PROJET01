        ...
        <div class="row g-0 gx-5 align-items-end">
            <div class="col-lg-6">
                <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                    <h1 class="mb-3">Liste d'immeubles en vente</h1>
...
$sql = "SELECT *, SUBSTRING_INDEX(photo, ',', 1) AS photo_principale FROM produits WHERE statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Immeuble' AND statut_Louer = 'A Vendre'";
...
$totalCountSQL = "SELECT COUNT(*) AS total FROM produits WHERE statut = 'Accepté' AND STATUS = 'Present' AND type_logement = 'Immeuble' AND statut_Louer = 'A Vendre'";
...
?>
    <div class="row">
        ...
        <?php
            ...
            echo '<div class="alert alert-info" role="alert">Aucun  Immeuble en vente n\'a encore été enregistré.</div>';
